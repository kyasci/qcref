...
!-----------------------------------------------------------------------
     ...
     &      /),(/NAC,NAC/))
          call run_('C2H4f',ian,r,cm,NX,NFC,NAC,MULT,v0,vlg)
        end subroutine

        subroutine test_ci_c2h4w3_()
!-----------------------------------------------------------------------
!      $CONTRL SCFTYP=NONE RUNTYP=ENERGY CITYP=GUGA $END
!      $SYSTEM MWORDS=10 $END
!      $BASIS GBASIS=STO NGAUSS=3 $END
!      $CIINP NRNFG(6)=1,1 NPFLG(7)=1 $END
!      $CIDRT NDOC=3 NFZC=5 NVAL=3 GROUP=C1 IEXCIT=3 $END
!      $GUESS GUESS=MOREAD NORB=14 $END
!      $DATA
!     TITLE
!     C1
...
!-----------------------------------------------------------------------
          implicit none
          integer,parameter::NA=6,NB=14,NX=3,NFC=5,NAC=6,MULT=1
          integer::ian(NA)
          real(8)::r(3,NA)=0d0,cm(NB,NB),v0,vlg(NAC,NAC)
          v0=-77.122751391d0
          ian(:)=(/6,6,1,1,1,1/)
     ...
     &      /),(/NB,NB/))
          vlg(:,:)=RESHAPE((/
     &      -1.0720317468d0, 0.0000000000d0, 0.0000000000d0,
     &      -0.0000000000d0,-0.0000000000d0,-0.0000000000d0,
     &       0.0000000000d0,-0.9102426106d0,-0.0000000000d0,
     &      -0.0000000000d0,-0.0000000000d0,-0.0000000000d0,
     &       0.0000000000d0,-0.0000000000d0,-0.6976160567d0,
     &       0.0000000000d0, 0.0000000000d0, 0.0000000000d0,
     &      -0.0000000000d0,-0.0000000000d0, 0.0000000000d0,
     &      -0.0804669535d0, 0.0000000000d0,-0.0000000000d0,
     &      -0.0000000000d0,-0.0000000000d0, 0.0000000000d0,
     &       0.0000000000d0,-0.0065367839d0,-0.0000000000d0,
     &      -0.0000000000d0,-0.0000000000d0, 0.0000000000d0,
     &      -0.0000000000d0,-0.0000000000d0,-0.0045442442d0
     &      /),(/NAC,NAC/))
          call run_('C2H4w3',ian,r,cm,NX,NFC,NAC,MULT,v0,vlg)
        end subroutine

        subroutine test_ci_c2h4w4_()
!-----------------------------------------------------------------------
!      $CONTRL SCFTYP=NONE RUNTYP=ENERGY CITYP=GUGA $END
!      $SYSTEM MWORDS=10 $END
!      $BASIS GBASIS=STO NGAUSS=3 $END
!      $CIINP NRNFG(6)=1,1 NPFLG(7)=1 $END
!      $CIDRT NDOC=3 NFZC=5 NVAL=5 GROUP=C1 IEXCIT=3 $END
!      $GUESS GUESS=MOREAD NORB=14 $END
!      $DATA
!     TITLE
!     C1
...
!-----------------------------------------------------------------------
          implicit none
          integer,parameter::NA=6,NB=14,NX=6,NFC=5,NAC=7,MULT=1
          integer::ian(NA)
          real(8)::r(3,NA)=0d0,cm(NB,NB),v0,vlg(NAC,NAC)
          v0=-77.125210704d0
          ian(:)=(/6,6,1,1,1,1/)
     ...
     &      /),(/NB,NB/))
          vlg(:,:)=RESHAPE((/
     &      -1.0745380628d0,-0.0000000000d0,-0.0000000000d0,
     &      -0.0000000000d0,-0.0000000000d0,-0.0000000000d0,
     &      -0.0019307730d0,
     &      -0.0000000000d0,-0.9128453783d0, 0.0000000000d0,
     &      -0.0000000000d0,-0.0000000000d0, 0.0000000000d0,
     &       0.0000000000d0,
     &      -0.0000000000d0, 0.0000000000d0,-0.6997620587d0,
     &       0.0000000000d0, 0.0000000000d0,-0.0000000000d0,
     &      -0.0000000000d0,
     &      -0.0000000000d0,-0.0000000000d0, 0.0000000000d0,
     &      -0.0814817409d0,-0.0000000000d0,-0.0000000000d0,
     &      -0.0000000000d0,
     &      -0.0000000000d0,-0.0000000000d0, 0.0000000000d0,
     &      -0.0000000000d0,-0.0068772338d0, 0.0000000000d0,
     &      -0.0000000000d0,
     &      -0.0000000000d0, 0.0000000000d0,-0.0000000000d0,
     &      -0.0000000000d0, 0.0000000000d0,-0.0044871099d0,
     &      -0.0000000000d0,
     &      -0.0019307656d0, 0.0000000000d0, 0.0000000000d0,
     &       0.0000000000d0,-0.0000000000d0, 0.0000000000d0,
     &      -0.0029009247d0
     &      /),(/NAC,NAC/))
          call run_('C2H4w4',ian,r,cm,NX,NFC,NAC,MULT,v0,vlg)
        end subroutine

        subroutine test_ci_c2h4w5_()
!-----------------------------------------------------------------------
!      $CONTRL SCFTYP=NONE RUNTYP=ENERGY CITYP=GUGA $END
!      $SYSTEM MWORDS=10 $END
!      $BASIS GBASIS=STO NGAUSS=3 $END
!      $CIINP NRNFG(6)=1,1 NPFLG(7)=1 $END
!      $CIDRT NDOC=3 NFZC=5 NVAL=6 GROUP=C1 IEXCIT=3 $END
!      $GUESS GUESS=MOREAD NORB=14 $END
!      $DATA
!     TITLE
!     C1
...
!-----------------------------------------------------------------------
          implicit none
          integer,parameter::NA=6,NB=14,NX=6,NFC=5,NAC=8,MULT=1
          integer::ian(NA)
          real(8)::r(3,NA)=0d0,cm(NB,NB),v0,vlg(NAC,NAC)
          v0=-77.129436188d0
          ian(:)=(/6,6,1,1,1,1/)
     ...
     &      /),(/NB,NB/))
          vlg(:,:)=RESHAPE((/
     &      -1.0770279499d0,-0.0000000000d0,-0.0000000000d0,
     &       0.0000000000d0, 0.0000000000d0, 0.0000000000d0,
     &       0.0002203861d0, 0.0000000000d0,
     &      -0.0000000000d0,-0.9181111735d0,-0.0000000000d0,
     &       0.0000000000d0, 0.0000000000d0, 0.0000000000d0,
     &       0.0000000000d0,-0.0020447887d0,
     &      -0.0000000000d0,-0.0000000000d0,-0.7005650382d0,
     &       0.0000000000d0, 0.0000000000d0, 0.0000000000d0,
     &       0.0000000000d0,-0.0000000000d0,
     &       0.0000000000d0, 0.0000000000d0, 0.0000000000d0,
     &      -0.0816198186d0, 0.0000000000d0,-0.0000000000d0,
     &       0.0000000000d0, 0.0000000000d0,
     &       0.0000000000d0, 0.0000000000d0, 0.0000000000d0,
     &       0.0000000000d0,-0.0060550513d0, 0.0000000000d0,
     &       0.0000000000d0, 0.0000000000d0,
     &       0.0000000000d0, 0.0000000000d0, 0.0000000000d0,
     &      -0.0000000000d0, 0.0000000000d0,-0.0039438450d0,
     &       0.0000000000d0, 0.0000000000d0,
     &       0.0002203851d0, 0.0000000000d0, 0.0000000000d0,
     &       0.0000000000d0, 0.0000000000d0, 0.0000000000d0,
     &      -0.0047178906d0, 0.0000000000d0,
     &      -0.0000000000d0,-0.0020447921d0,-0.0000000000d0,
     &       0.0000000000d0, 0.0000000000d0, 0.0000000000d0,
     &       0.0000000000d0,-0.0043086673d0
     &      /),(/NAC,NAC/))
          call run_('C2H4w5',ian,r,cm,NX,NFC,NAC,MULT,v0,vlg)
        end subroutine

!         subroutine test_ci_c2h4w6_()
! !-----------------------------------------------------------------------
! !      $CONTRL SCFTYP=NONE RUNTYP=ENERGY CITYP=GUGA $END
! !      $SYSTEM MWORDS=10 $END
! !      $BASIS GBASIS=STO NGAUSS=3 $END
! !      $CIINP NRNFG(6)=1,1 NPFLG(7)=1 $END
! !      $CIDRT NDOC=4 NFZC=4 NVAL=4 GROUP=C1 IEXCIT=4 $END
! !      $GUESS GUESS=MOREAD NORB=14 $END
! !      $DATA
! !     TITLE
! !     C1
...
! !-----------------------------------------------------------------------
!           implicit none
!           integer,parameter::NA=6,NB=14,NX=4,NFC=4,NAC=8,MULT=1
!           integer::ian(NA)
!           real(8)::r(3,NA)=0d0,cm(NB,NB),v0,vlg(NAC,NAC)
!           v0=-77.136111289d0
!           ian(:)=(/6,6,1,1,1,1/)
...
!      &      /),(/NB,NB/))
!           vlg(:,:)=RESHAPE((/
!      &  -1.1967788548d0,-0.0000000000d0, 0.0000000000d0,-0.0000000000d0, 
!      &   0.0000000000d0, 0.0002494678d0,-0.0000000000d0,-0.0000000000d0,
!      &   0.0000000000d0,-1.0779900649d0,-0.0000000000d0, 0.0000000000d0,
!      &   0.0000000000d0,-0.0000000000d0,-0.0000000000d0,-0.0021971468d0,
!      &  -0.0000000000d0, 0.0000000000d0,-0.9161594335d0, 0.0000000000d0,
!      &  -0.0000000000d0, 0.0000000000d0,-0.0000000000d0, 0.0000000000d0,
!      &  -0.0000000000d0, 0.0000000000d0, 0.0000000000d0,-0.7015206622d0,
!      &   0.0000000000d0, 0.0000000000d0,-0.0000000000d0, 0.0000000000d0,
!      &   0.0000000000d0, 0.0000000000d0,-0.0000000000d0, 0.0000000000d0,
!      &  -0.0814544975d0,-0.0000000000d0, 0.0000000000d0,-0.0000000000d0,
!      &   0.0002433960d0,-0.0000000000d0, 0.0000000000d0, 0.0000000000d0,
!      &   0.0000000000d0,-0.0136115661d0,-0.0000000000d0,-0.0000000000d0,
!      &  -0.0000000000d0,-0.0000000000d0,-0.0000000000d0,-0.0000000000d0,
!      &   0.0000000000d0, 0.0000000000d0,-0.0092016003d0,-0.0000000000d0,
!      &  -0.0000000000d0,-0.0022115564d0, 0.0000000000d0, 0.0000000000d0,
!      &  -0.0000000000d0, 0.0000000000d0, 0.0000000000d0,-0.0100220251d0 
!      &      /),(/NAC,NAC/))
!           call run_('C2H4w',ian,r,cm,NX,NFC,NAC,MULT,v0,vlg)
!         end subroutine
        ...
        subroutine test_main()
          ...
          call test_ci_c2h4_()
          call test_ci_c2h4f_()
          call test_ci_c2h4w3_()
          call test_ci_c2h4w4_()
          call test_ci_c2h4w5_()
        end subroutine
